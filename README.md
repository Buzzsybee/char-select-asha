# Commission work for Asha The Crocodile

<h6>Fully fledged moveset is included :3!</h6>
...
**While in water Z: Underwater Ground Pound** - The Ground Pound! Now in water form!

**While in water Z -> B: Death Roll** - A forward boost that makes swimming faster and attacks at the same time!

**While holding something -> A -> Z while airborne: Spinning Pile Driver** - Slam the enemy to the ground causing an explosion that hits other surrounding enemies! You are invincible while the explosion is active.
